      ...
      <main>
        ...
        >
          <div className="flex flex-col gap-y-4 text-center">
            <p className="text-gray-800 text-5xl font-semibold font-['Poppins']">
              +50
            </p>
            <p className="text-gray-800 text-[28px] font-semibold font-['Poppins']">
              Parceiros
            </p>
          </div>
          <div className="flex flex-col gap-y-4 text-center">
        ...
        >
          <p className="text-gray-800 text-4xl font-semibold font-['Poppins']">
            ...
            >
              <div className="flex-col flex justify-center items-center  gap-8 content-center">
                ...
                <div className="txt-center">
                  <h2 className="w-[248px] text-zinc-700 text-xl font-semibold font-['Poppins']">
                    Fidelização dos clientes
                  </h2>
                  <p className="w-[231px] h-[78px] text-center text-zinc-700 text-base font-normal font-['Poppins']">
        ...
        >
          <h2 className="text-black text-5xl font-semibold font-['Poppins'] m-8">
