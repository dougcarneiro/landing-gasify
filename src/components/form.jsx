      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        >
          <div>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                maxLength="9"
                className={`shadow-sm bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${cepError ? "border-red-500" : "border-gray-300"}`}
          ...
          <div className="col-span-2 flex justify-between">
            <button
              type="button"
              className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center"
            ...
            <button
              type="button"
              onClick={handleReset}
              className="text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center"
            >
              Limpar
            </button>
          </div>
